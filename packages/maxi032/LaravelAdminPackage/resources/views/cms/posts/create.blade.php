            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="createOrEditForm" class="validationForm" method="{{ Str::endsWith(Route::currentRouteName(), '.create') ? 'POST' : 'PUT' }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="slug_{{$language['code']}}" type="text"
                                                       ...
                                                       value="{{ old('translations.slug.'.$language['code']) }}" autocomplete="translations['slug'][{{$language['code']}}]"
                                                       autofocus>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <textarea id="excerpt_{{$language['code']}}" class="form-control"
                                                          name="translations[excerpt][{{$language['code']}}]" rows="3">{{ old('translations.excerpt.'.$language['code']) }}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <textarea id="content_{{$language['code']}}" class="form-control"
                                                          name="translations[content][{{$language['code']}}]" rows="3">{{ old('translations.content.'.$language['code']) }}</textarea>
